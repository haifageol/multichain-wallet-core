<p align="center">
  <b>multichain-wallet-core</b>
</p>

<p align="center">
  <sub>btc · eth · l2 · local vault</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>McWallet</code> &nbsp;·&nbsp; <code>mcwallet</code>
</p>
...
Desktop wallet skeleton — import seed, sync balances, sign locally. No cloud account, no telemetry.

Forked from an internal OTC tool and left public because other desks kept asking for the same binary.
...
```bash
dotnet restore multichain-wallet-core.slnx
dotnet build multichain-wallet-core.slnx -c Release
dotnet test multichain-wallet-core.slnx -c Release
```
